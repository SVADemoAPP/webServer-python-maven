...
//            						"bVisible": false,
            					...
            					},
            					{
            	                    ...
            	                    "mRender": function ( data, type, full ) {
            	                    	var html = "" +
            	                    		'<input type="button" data-type="ticketEdt" style="width: 54px;height:30px;font-size: 13px;font-family:inherit;" data-placeid="'+full.placeId+'" data-shopId="'+full.shopId+'" data-xSpot="'+full.xSpot+'" data-ySpot="'+full.ySpot+'" data-floorno="'+full.floorNo+'" value="'+i18n_edit+'" id="'+full.ticketId+' ">' +
            	                    		'<input type="button" data-type="ticketDel" style="width: 54px;height:30px;font-size: 13px;font-family:inherit;" data-floorNo="'+full.floorNo+'" data-shopId="'+full.shopId+'" id="'+full.ticketId+'" data-id="'+full.id+'" data-xSpot="'+full.xSpot+'" data-ySpot="'+full.ySpot+'" value="'+i18n_delete+'">';
            	                        return html;
            	                      }
            	                }
            				],
        	                ...
        	                },
        					{
        	                    ...
        	                    "mRender": function ( data, type, full ) {
        	                    	var html = "" +
        	                    		...
        	                    		'<a data-type="ticket" role="button" class="btn"  style="font-size:13px;" data-floorNo="'+full.floorNo+'" data-id="'+full.id+'"  data-xSpot="'+full.xSpot+'" data-ySpot="'+full.ySpot+'" data-pictrue="'+full.pictruePath+'" data-movie="'+full.moviePath+'">'+i18n_ticket+'</a>';
        	                        return html;
        	                      }
        	                }
        				],
